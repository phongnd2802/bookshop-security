        ...
        <div class="card-body">
          ...
          >
            ...
            <div class="mb-3">
              ...
              <input
                type="text"
                class="form-control ${not empty requestScope.violations.fullnameViolations ? 'is-invalid' : (not empty requestScope.values.fullname ? 'is-valid' : '')}"
                id="inputFullname"
                name="fullname"
            ...
            <div class="mb-3">
              ...
              <input
                type="email"
                class="form-control ${not empty requestScope.violations.emailViolations ? 'is-invalid' : (not empty requestScope.values.email ? 'is-valid' : '')}"
                id="inputEmail"
                name="email"
            ...
            <div class="mb-3">
              ...
              <input
                type="text"
                class="form-control ${not empty requestScope.violations.phoneNumberViolations ? 'is-invalid' : (not empty requestScope.values.phoneNumber ? 'is-valid' : '')}"
                id="inputPhoneNumber"
                name="phoneNumber"
            ...
            <div class="mb-3">
              <div class="form-check d-inline-block me-4">
                ...
                requestScope.violations.genderViolations ? 'is-invalid' : (not
                empty requestScope.values.gender ? 'is-valid' : '')}"
              ...
              <c:if
                test="${not empty requestScope.violations.genderViolations}"
              >
            ...
            <div class="mb-3">
              ...
              <input
                type="text"
                class="form-control ${not empty requestScope.violations.addressViolations ? 'is-invalid' : (not empty requestScope.values.address ? 'is-valid' : '')}"
                id="inputAddress"
                name="address"
            ...
            <div class="mb-3 form-check">
              <input
                class="form-check-input ${not empty requestScope.violations.policyViolations ? 'is-invalid' : (not empty requestScope.values.policy ? 'is-valid' : '')}"
                type="checkbox"
                value="checked"
                id="checkboxPolicy"
                name="policy"
              ...
              <c:if
                test="${not empty requestScope.violations.policyViolations}"
              >
                <div class="invalid-feedback">
                  <ul class="list-unstyled">
                    <c:forEach
