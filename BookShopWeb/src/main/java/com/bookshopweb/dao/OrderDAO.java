...
public interface OrderDAO extends DAO<Order> {
    ...
    @Override
    @SqlUpdate("UPDATE orders SET userId = :userId, status = :status, deliveryMethod = :deliveryMethod, " + "deliveryPrice = :deliveryPrice, createdAt = :createdAt, updatedAt = :updatedAt WHERE id = :id")
    ...
    List<Order> getOrderedPart(@Bind("limit") int limit, @Bind("offset") int offset, @Define("orderBy") String orderBy, @Define("orderDir") String orderDir);
